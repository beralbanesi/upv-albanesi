      ...
      <div className="product-container">
        <div className="product-content">
          ...
          <div className="selected-card-item-category">>>> {selectedProduct.category}</div>
            ...
            <div className="selected-card-item-title">Precio: ${selectedProduct.price}   </div>
            <ul className= 'selected-card-item-ul'>
                ...
                <li><span className="selected-card-item-description">Talle: {selectedProduct.size}</span></li>
                ...
                {/* <li><div className="color-btn"><a href="#"></a></div></li>                 */}
                {/* <li><span className="selected-card-item-description">Colores disponibles:</span>
                  <ul className='color-info'>
                    {selectedProduct.colors.map ((color, i) => {return <li key={i} style={{background: `${color}`, listStyle: `none`}}><a href="#"></a></li>
                  })
                  }
                  </ul>
                </li>         */}
            ...
            : <button className="addCart-btn" onClick={()=> {navigate(`/cart`)}} >Finalizar compra</button>
